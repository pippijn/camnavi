...
static std::ostream &
operator << (std::ostream &os, SiftGPU::SiftKeypoint &key)
{
...
int main()
{
    ...
    if(sift->RunSIFT(SRCDIR"/images/001.jpg"))
    {
    ...
    if(sift->RunSIFT(SRCDIR"/images/002.jpg"))
    {
