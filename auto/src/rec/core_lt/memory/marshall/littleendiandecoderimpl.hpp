...
#ifndef _REC_MARSHALL_LITTLEENDIANDECODERIMPL_H_
#define _REC_MARSHALL_LITTLEENDIANDECODERIMPL_H_
...
namespace rec
{
	namespace core_lt
	{
		namespace memory
		{
			namespace marshall
			{
				class LittleEndianDecoderImpl : public DecoderImpl
				{
				public:
					LittleEndianDecoderImpl( const ByteArrayConst& buffer )
						: DecoderImpl( buffer )
					{
					}
