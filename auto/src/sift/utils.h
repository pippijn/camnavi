 ...
 */
static inline int
pixval8 (IplImage *img, int r, int c)
{
 ...
 */
static inline void
setpix8 (IplImage *img, int r, int c, uchar val)
{
 ...
 */
static inline float
pixval32f (IplImage *img, int r, int c)
{
 ...
 */
static inline void
setpix32f (IplImage *img, int r, int c, float val)
{
...
pixval64f (IplImage *img, int r, int c)
{
 ...
 */
static inline void
setpix64f (IplImage *img, int r, int c, double val)
{
