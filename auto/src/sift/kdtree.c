 ...
 */
struct kd_node *
kdtree_build (struct feature *features, int n)
{
 ...
 */
int
kdtree_bbf_knn (struct kd_node *kd_root, struct feature *feat, int k,
 ...
 */
int
kdtree_bbf_spatial_knn (struct kd_node *kd_root, struct feature *feat,
 ...
 */
void
kdtree_release (struct kd_node *kd_root)
{
  if (!kd_root)
    return;
 ...
 */
static struct kd_node *
kd_node_init (struct feature *features, int n)
{
 ...
 */
static void
expand_kd_node_subtree (struct kd_node *kd_node)
{
  /* base case: leaf node */
 ...
 */
static void
assign_part_key (struct kd_node *kd_node)
{
 ...
 */
static double
median_select (double *array, int n)
{
 ...
 */
static double
rank_select (double *array, int n, int r)
{
  double *tmp, med;
 ...
 */
static void
insertion_sort (double *array, int n)
{
  double k;
  int i, j;
 ...
 */
static int
partition_array (double *array, int n, double pivot)
{
  double tmp;
  int p, i, j;
 ...
 */
static void
partition_features (struct kd_node *kd_node)
{
 ...
 */
static struct kd_node *
explore_to_leaf (struct kd_node *kd_node,
                 struct feature *feat,
                 struct min_pq *min_pq)
{
 ...
 */
static int
insert_into_nbr_array (struct feature *feat, struct feature **nbrs,
                       int n, int k)
{
 ...
 */
static int
within_rect (CvPoint2D64f pt, CvRect rect)
{
