 ...
 */
int
sift_features (IplImage *img, struct feature **feat)
{
 ...
 */
int
_sift_features (IplImage *img, struct feature **feat, int intvls,
 ...
 */
static IplImage *
create_init_img (IplImage *img, int img_dbl, double sigma)
{
  IplImage *gray, *dbl;
  double sig_diff;
 ...
 */
static IplImage *
convert_to_gray32 (IplImage *img)
{
 ...
 */
static IplImage ***
build_gauss_pyr (IplImage *base, int octvs,
 ...
 */
static IplImage ***
build_dog_pyr (IplImage ***gauss_pyr, int octvs, int intvls)
{
  IplImage ***dog_pyr;
  int i, o;
 ...
 */
static CvSeq *
scale_space_extrema (IplImage ***dog_pyr, int octvs, int intvls,
 ...
 */
static int
is_extremum (IplImage ***dog_pyr, int octv, int intvl, int r, int c)
{
...
interp_extremum (IplImage ***dog_pyr, int octv,
...
static void
interp_step (IplImage ***dog_pyr, int octv, int intvl, int r, int c,
 ...
 */
static CvMat *
deriv_3D (IplImage ***dog_pyr, int octv, int intvl, int r, int c)
{
  CvMat *dI;
  double dx, dy, ds;
 ...
 */
static CvMat *
hessian_3D (IplImage ***dog_pyr, int octv, int intvl, int r,
            int c)
{
  CvMat *H;
 ...
 */
static double
interp_contr (IplImage ***dog_pyr, int octv, int intvl, int r,
 ...
 */
static int
is_too_edge_like (IplImage *dog_img, int r, int c, int curv_thr)
{
 ...
 */
static void
calc_feature_scales (CvSeq *features, double sigma, int intvls)
{
  struct feature *feat;
  struct detection_data *ddata;
  double intvl;
 ...
 */
static void
adjust_for_img_dbl (CvSeq *features)
{
  struct feature *feat;
  int i, n;
 ...
 */
static void
calc_feature_oris (CvSeq *features, IplImage ***gauss_pyr)
{
  struct feature *feat;
  struct detection_data *ddata;
  double *hist;
 ...
 */
static double *
ori_hist (IplImage *img, int r, int c, int n, int rad,
          double sigma)
{
  double *hist;
 ...
 */
static int
calc_grad_mag_ori (IplImage *img, int r, int c, double *mag,
                   double *ori)
{
  double dx, dy;
 ...
 */
static void
smooth_ori_hist (double *hist, int n)
{
 ...
 */
static double
dominant_ori (double *hist, int n)
{
  double omax;
  int maxbin, i;
 ...
 */
static void
add_good_ori_features (CvSeq *features, double *hist, int n,
 ...
 */
static struct feature *
clone_feature (struct feature *feat)
{
  struct feature *new_feat;
  struct detection_data *ddata;
 ...
 */
static void
compute_descriptors (CvSeq *features, IplImage ***gauss_pyr, int d,
                     int n)
{
  struct feature *feat;
  struct detection_data *ddata;
 ...
 */
static double ***
descr_hist (IplImage *img, int r, int c, double ori,
 ...
 */
static void
interp_hist_entry (double ***hist, double rbin, double cbin,
 ...
 */
static void
hist_to_descr (double ***hist, int d, int n, struct feature *feat)
{
 ...
 */
static void
normalize_descr (struct feature *feat)
{
 ...
 */
static int
feature_cmp (void *feat1, void *feat2, void *param)
{
 ...
 */
static void
release_descr_hist (double ****hist, int d)
{
  int i, j;
 ...
 */
static void
release_pyr (IplImage ****pyr, int octvs, int n)
{
  int i, j;
