...
private:
  ...
  void GetBestMatch (MatchBuffer &match_buffer, float distmax, float ratiomax, int mbm);
...
public:
  ...
  void GetSiftMatch (MatchBuffer &match_buffer, float distmax, float ratiomax, int mbm);
  void GetGuidedSiftMatch (MatchBuffer &match_buffer, float H[3][3], float F[3][3],
