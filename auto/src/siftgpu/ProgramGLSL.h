...
public:
  virtual void
  SetGenListInitParam (int w, int h)
  {
  }

  virtual void
  SetGenListEndParam (int ktex)
  {
  }

  virtual void
  SetMarginCopyParam (int xmax, int ymax)
  {
  }
  ...
  virtual void
  SetFeatureOrientationParam (int gtex, int width, int height, float sigma, int stex, float step)
  {
  }

  virtual void
  SetSimpleOrientationInput (int oTex, float sigma, float sigma_step)
  {
  }
...
public:
  ShaderBagPKSL ()
  {
    s_rect_description = NULL;
  }

  virtual
  ~ShaderBagPKSL ()
  {
    if (s_rect_description)
      delete s_rect_description;
  }
