...
void
FrameBufferObject::AttachDepthTexture (GLenum textureTarget, GLuint texID)
{
  glFramebufferTexture2DEXT (GL_FRAMEBUFFER_EXT, GL_DEPTH_ATTACHMENT_EXT, textureTarget, texID, 0);
}

void
FrameBufferObject::AttachTexture (GLenum textureTarget, GLenum attachment, GLuint texId)
{
...
void
FrameBufferObject::UnattachTex (GLenum attachment)
{
...
void
FrameBufferObject::UnattachRenderBuffer (GLenum attachment)
{
