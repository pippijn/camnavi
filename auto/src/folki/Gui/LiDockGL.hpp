...
#ifndef __LI_DOCK_GL_HPP
#define __LI_DOCK_GL_HPP

#include "LiGL2Dwidget.hpp"

namespace LIVA
{
class LiDockGL :  public QDockWidget
{
	Q_OBJECT
private:
	GLuint  texture;
	void loadGLTextures(GLuint pbo,GLsizei image_width, GLsizei image_height);
public:
