 ...
 */
int
import_features (char *filename, int type, struct feature **feat)
{
  int n;
 ...
 */
int
export_features (char *filename, struct feature *feat, int n)
{
  int r, type;
 ...
 */
void
draw_features (IplImage *img, struct feature *feat, int n)
{
  int type;
 ...
 */
double
descr_dist_sq (struct feature *f1, struct feature *f2)
{
  double diff, dsq = 0;
 ...
 */
static int
import_oxfd_features (char *filename, struct feature **features)
{
  struct feature *f;
  int i, j, n, d;
  double x, y, a, b, c, dv;
 ...
 */
static int
export_oxfd_features (char *filename, struct feature *feat, int n)
{
  FILE *file;
  int i, j, d;
 ...
 */
static void
draw_oxfd_features (IplImage *img, struct feature *feat, int n)
{
 ...
 */
static void
draw_oxfd_feature (IplImage *img, struct feature *feat,
                   CvScalar color)
{
  double m[4] = {
    feat->a, feat->b, feat->b, feat->c
  };
  double v[4] = {
    0
  };
 ...
 */
static int
import_lowe_features (char *filename, struct feature **features)
{
  struct feature *f;
  int i, j, n, d;
  double x, y, s, o, dv;
 ...
 */
static int
export_lowe_features (char *filename, struct feature *feat, int n)
{
  FILE *file;
  int i, j, d;
 ...
 */
static void
draw_lowe_features (IplImage *img, struct feature *feat, int n)
{
  CvScalar color = CV_RGB (255, 255, 255);
  int i;
 ...
 */
static void
draw_lowe_feature (IplImage *img, struct feature *feat,
                   CvScalar color)
{
