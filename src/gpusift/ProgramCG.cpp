...
ProgramCG::ProgramCG (const char *code, const char **cg_compile_args, CGprofile profile)
{
  ...
  GLint epos;
  const char *ati_args[] = {
    "-po", "ATI_draw_buffers", 0
  };
  const char *fp40_args[] = {
    "-ifcvt", "none", "-unroll", "all", GlobalUtil::_UseFastMath ? "-fastmath" : 0, 0
  };
  if (cg_compile_args == NULL)
    cg_compile_args = GlobalUtil::_IsNvidia ? (GlobalUtil::_SupportFP40 ? fp40_args : NULL) : ati_args;
  ...
  if (_Context == 0)
    {
      ...
      if (GlobalUtil::_verbose)
        std::cout << "Shader Profile: " << cgGetProfileString (_FProfile) << endl;
...
void
ShaderBagCG::LoadDisplayShaders ()
{
...
void
ShaderBagCG::SetMarginCopyParam (int xmax, int ymax)
{
  float truncate[2] = {
    xmax - 0.5f, ymax - 0.5f
  };
...
int
ShaderBagCG::LoadKeypointShaderMR (float threshold, float edge_threshold)
{
  char buffer[10240];
...
void
ShaderBagCG::LoadKeypointShader (float threshold, float edge_threshold)
{
  char buffer[10240];
...
void
ShaderBagCG::SetDogTexParam (int texU, int texD)
{
...
void
ShaderBagCG::SetGenListStepParam (int tex, int tex0)
{
...
void
ShaderBagCG::SetGenVBOParam (float width, float fwidth, float size)
{
  float sizes[4] = {
...
ProgramGPU *
FilterGLCG::CreateFilterH (float kernel[], float offset[], int width)
{
  char buffer[10240];
  ostrstream out (buffer, 10240);
...
ProgramGPU *
FilterGLCG::CreateFilterV (float kernel[], float offset[], int height)
{
  char buffer[10240];
  ostrstream out (buffer, 10240);
...
ProgramGPU *
FilterGLCG::CreateFilterHPK (float kernel[], float offset[], int width)
{
...
ProgramGPU *
FilterGLCG::CreateFilterVPK (float kernel[], float offset[], int height)
{
  //both h and v are packed...
  int i, j, yw, ywn;
  int halfh = height >> 1;
...
void
ShaderBagCG::LoadGenListShader (int ndoglev, int nlev)
{
  ProgramCG *program;
...
ProgramCG *
ShaderBagCG::LoadGenListStepShader (int start, int step)
{
  int i;
  char buffer[10240];
  //char chanels[5] = "rgba";
...
void
ShaderBagCG::SetGenListInitParam (int w, int h)
{
  float bbox[2] = {
    w - 1.0f, h - 1.0f
  };
...
void
ShaderBagCG::SetGenListStartParam (float width, int tex0)
{
...
void
ShaderBagCG::LoadDescriptorShaderF2 ()
{
...
void
ShaderBagCG::LoadDescriptorShader ()
{
...
void
ShaderBagCG::LoadOrientationShader ()
{
  char buffer[10240];
  ostrstream out (buffer, 10240);
...
void
ShaderBagCG::WriteOrientationCodeToStream (std::ostream &out)
{
...
void
ShaderBagCG::SetSimpleOrientationInput (int oTex, float sigma, float sigma_step)
{
...
void
ShaderBagCG::SetFeatureOrientationParam (int gtex, int width, int height, float sigma, int stex, float step)
{
  ///
...
void
ShaderBagCG::SetFeatureDescirptorParam (int gtex, int otex, float dwidth, float fwidth, float width, float height, float sigma)
{
  ///
...
void
ShaderBagPKCG::LoadFixedShaders ()
{
  ProgramCG *program;
...
void
ShaderBagPKCG::LoadDisplayShaders ()
{
  ProgramCG *program;
...
void
ShaderBagPKCG::LoadGenListShader (int ndoglev, int nlev)
{
...
void
ShaderBagPKCG::LoadGenListShaderV2 (int ndoglev, int nlev)
{
  ProgramCG *program;
...
ProgramCG *
ShaderBagCG::LoadGenListStepShaderV2 (int start, int step)
{
  int i;
  char buffer[10240];
  //char chanels[5] = "rgba";
...
void
ShaderBagPKCG::LoadKeypointShader (float threshold, float edge_threshold)
{
  //
  ProgramCG *program;
  char buffer[10240];
...
void
ShaderBagPKCG::LoadOrientationShader ()
{
  char buffer[10240];
  ostrstream out (buffer, 10240);
...
void
ShaderBagPKCG::LoadDescriptorShader ()
{
  GlobalUtil::_DescriptorPPT = 16;
  LoadDescriptorShaderF2 ();
}
...
void
ShaderBagPKCG::LoadDescriptorShaderF2 ()
{
  //one shader outpout 128/8 = 16 , each fragout encodes 4
  //const double twopi = 2.0*3.14159265358979323846;
  //const double rpi  = 8.0/twopi;
...
void
ShaderBagPKCG::SetMarginCopyParam (int xmax, int ymax)
{
  float truncate[4];
...
void
ShaderBagPKCG::SetGradPassParam (int texP)
{
...
void
ShaderBagPKCG::SetGenListEndParam (int ktex)
{
...
void
ShaderBagPKCG::SetDogTexParam (int texU, int texD)
{
  cgGLSetTextureParameter (_param_dog_texu, texU);
  cgGLEnableTextureParameter (_param_dog_texu);
  cgGLSetTextureParameter (_param_dog_texd, texD);
...
void
ShaderBagPKCG::SetGenListInitParam (int w, int h)
{
  float bbox[4] = {
...
void
ShaderBagPKCG::SetGenListStartParam (float width, int tex0)
{
  cgGLSetParameter1f (_param_ftex_width, width);
...
void
ShaderBagPKCG::SetGenListStepParam (int tex, int tex0)
{
  cgGLSetTextureParameter (_param_genlist_step_tex, tex);
  cgGLEnableTextureParameter (_param_genlist_step_tex);
  cgGLSetTextureParameter (_param_genlist_step_tex0, tex0);
...
void
ShaderBagPKCG::SetGenVBOParam (float width, float fwidth, float size)
{
  float sizes[4] = {
    size *3.0f, fwidth, width, 1.0f / width
  };
...
void
ShaderBagPKCG::SetSimpleOrientationInput (int oTex, float sigma, float sigma_step)
{
  cgGLSetTextureParameter (_param_orientation_gtex, oTex);
  cgGLEnableTextureParameter (_param_orientation_gtex);
...
void
ShaderBagPKCG::SetFeatureOrientationParam (int gtex, int width, int height, float sigma, int otex, float step)
{
  ///
  cgGLSetTextureParameter (_param_orientation_gtex, gtex);
  cgGLEnableTextureParameter (_param_orientation_gtex);
...
void
ShaderBagPKCG::SetFeatureDescirptorParam (int gtex, int otex, float dwidth, float fwidth, float width, float height, float sigma)
{
  ///
