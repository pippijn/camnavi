...
void
CuTexImage::SetImageSize (int width, int height)
{
  _imgWidth = width;
  _imgHeight = height;
}
...
void
CuTexImage::InitTexture (int width, int height, int nchannel)
{
  int size;
...
void
CuTexImage::CopyFromHost (const void *buf)
{
  if (_cuData == NULL)
    return;
...
void
CuTexImage::CopyToHost (void *buf)
{
  if (_cuData == NULL)
    return;
...
void
CuTexImage::CopyToHost (void *buf, int stream)
{
  if (_cuData == NULL)
    return;
...
int
CuTexImage::DebugCopyToTexture2D ()
{
  /*	CuTexImage tex;
...
void
CuTexImage::CopyFromPBO (int width, int height, GLuint pbo)
{
  void *pbuf = NULL;
...
int
CuTexImage::CopyToPBO (GLuint pbo)
{
  void *pbuf = NULL;
