...
typedef std::vector<boost::array<int, 2> > MatchBuffer;
...
public:
  ...
  SIFTGPU_EXPORT virtual void GetSiftMatch (
    MatchBuffer &match_buffer,                             //buffer to receive the matched feature indices
  ...
  SIFTGPU_EXPORT virtual void GetGuidedSiftMatch (
    MatchBuffer &match_buffer,                                     //buffer to recieve
